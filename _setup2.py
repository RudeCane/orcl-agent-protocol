...
# fetcher.py
code = '''import time, logging, requests
...
class OrderBookFetcher:
    ...
    def get_blofin_orderbook(self, inst_id="BTC-USDT", depth=20):
        ...
        try:
            resp = requests.get(f"{BLOFIN_API}/market/books", params={"instId": inst_id, "size": depth}, timeout=10)
            data = resp.json()
...
with open("orderbook/fetcher.py", "w") as f:
    f.write(code)
print("Created fetcher.py")
